...
{
    [Area("BasicInput")]
    public class SliderImage2Controller : BaseController
    {
        #region Services
        ...
        #region Constructor
        public SliderImage2Controller(ISlidersService thisService, ICommonService commonService, IWebHostEnvironment hostingEnvironment, IHttpContextAccessor httpContextAccessor)
        ...
        {
            var result = await _thisService.GetAllByTypeAsync(2);
        ...
        public async Task<IActionResult> Create()
        {
           SlidersVm Obj = new SlidersVm();
            ...
            return PartialView("~/Areas/BasicInput/Views/SliderImage2/Create.cshtml", Obj);
        }
        [HttpPost]
        ...
        public async Task<IActionResult> Delete(int id)
        {
            SlidersVm obj = new SlidersVm();
            obj.Id = id;
            return PartialView("~/Areas/BasicInput/Views/SliderImage2/Delete.cshtml", obj);
        }
