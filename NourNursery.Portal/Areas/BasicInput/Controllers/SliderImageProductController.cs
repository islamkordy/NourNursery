...
{
    [Area("BasicInput")]
    public class SliderImageProductController : BaseController
    {
        #region Services
        ...
        #region Constructor
        public SliderImageProductController(ISlidersService thisService, ICommonService commonService, IWebHostEnvironment hostingEnvironment, IHttpContextAccessor httpContextAccessor)
        ...
        {
            var result = await _thisService.GetAllByTypeAsync(3);
        ...
        public async Task<IActionResult> Create()
        {
           SlidersVm Obj = new SlidersVm();
            ...
            return PartialView("~/Areas/BasicInput/Views/SliderImageProduct/Create.cshtml", Obj);
        }
        [HttpPost]
        ...
        public async Task<IActionResult> Delete(int id)
        {
            SlidersVm obj = new SlidersVm();
            obj.Id = id;
            return PartialView("~/Areas/BasicInput/Views/SliderImageProduct/Delete.cshtml", obj);
        }
