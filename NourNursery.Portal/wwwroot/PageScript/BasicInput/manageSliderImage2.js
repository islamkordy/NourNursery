...
function Create() {
    var Url = "/BasicInput/SliderImage2/Create";
    // window.location = Url;
...
function Details(id) {
    var Url = "/BasicInput/SliderImage2/Details?Id=" + id;
    $('#myModalAddEdit').load(Url, function (response, status, xhr) {
        $('#myModalAddEdit').modal('show');
    });
}
...
function Edit(id) {
    var Url = "/BasicInput/SliderImage2/Edit?Id=" + id;
    $('#myModalAddEdit').load(Url, function (response, status, xhr) {
        $('#myModalAddEdit').modal('show');
    });
}
function Delete(id) {
    var Url = "/BasicInput/SliderImage2/Delete?Id=" + id;
    $('#myModalAddEdit').load(Url, function (response, status, xhr) {
        $('#myModalAddEdit').modal('show');
    });
}
function DeleteRow(id) {
    var Url = "/BasicInput/SliderImage2/DeleteRow?Id=" + id;
...
function search() {
    ...
    var url = "/BasicInput/SliderImage2/Search";
