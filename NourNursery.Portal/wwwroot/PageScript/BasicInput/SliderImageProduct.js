...
function Create() {
    var Url = "/BasicInput/SliderImageProduct/Create";
    // window.location = Url;
...
function Details(id) {
    var Url = "/BasicInput/SliderImageProduct/Details?Id=" + id;
    $('#myModalAddEdit').load(Url, function (response, status, xhr) {
        $('#myModalAddEdit').modal('show');
    });
}
...
function Edit(id) {
    var Url = "/BasicInput/SliderImageProduct/Edit?Id=" + id;
    $('#myModalAddEdit').load(Url, function (response, status, xhr) {
        $('#myModalAddEdit').modal('show');
    });
}
function Delete(id) {
    var Url = "/BasicInput/SliderImageProduct/Delete?Id=" + id;
    $('#myModalAddEdit').load(Url, function (response, status, xhr) {
        $('#myModalAddEdit').modal('show');
    });
}
function DeleteRow(id) {
    var Url = "/BasicInput/SliderImageProduct/DeleteRow?Id=" + id;
...
function search() {
    ...
    var url = "/BasicInput/SliderImageProduct/Search";
