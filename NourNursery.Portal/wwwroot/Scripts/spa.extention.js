...
var spa = {
    ...
    _FollowModel: function () {
        $("#SearchResult").delegate(".FollowModel", "click", function () {
            var that = this;
            var Url = $(that).attr("href")
    ...
    _DataTable: function (language, ColumnVisibilty) {

        $('#dt-basic-example').dataTable({
            language: {
                "url": "/css/datagrid/datatables/" + language
            },
            ...
            buttons: [
                {
                    extend: 'colvis',
                    text: ColumnVisibilty,
                    titleAttr: 'Col visibility',
                    className: 'mr-sm-3'
                },
                {
                    extend: 'pdfHtml5',
                    text: "<span class='fal fa-file-pdf  '></span>",
                    titleAttr: 'PDF',
                    className: 'btn btn-danger btn-icon rounded-circle waves-effect waves-themed'
                },
                {
                    extend: 'excelHtml5',
                    text: "<span class='fal fa-file-excel  '></span>",
                    titleAttr: 'Excel',
                    className: 'btn btn-success btn-icon rounded-circle waves-effect waves-themed '
                },
                ,
                {
                    //extend: 'Add',
                    ...
                    titleAttr: 'New',
                    className: 'btn btn-secondary btn-icon rounded-circle waves-effect waves-themed',
                ...
                },
                {
                    ...
                    titleAttr: 'Delete',
                    className: 'btn btn-default btn-icon rounded-circle waves-effect waves-themed',
                    action: function (e, dt, node, config) {
                        DeleteAll();
                    }
                }
    ...
    _DataTablePaging: function (language, ColumnVisibilty, FunPass, ItemList,PrimaryCol) {
        ...
        var arrayCol = [{
            "data": PrimaryCol,
            "render": function (row) {
                return `  <a class="btn btn-icon-only green editModel" onclick="Edit(${row})">
        ...
        },
            {
                "data": PrimaryCol,
                "render": function (row) {
                    return ` <a class="btn btn-icon-only red Delete" onclick="DeleteRow(${row}$)" style="color:red">
        ...
        $('#CustomDataTable').dataTable({
            ...
            "columns": $.merge($.merge([], ItemList), arrayCol) //ItemList
        });
    },
