...
namespace Domain.Services.BasicInput
{
    ...
    public class RequestService : BaseService<TBL_ContactUs, ContactUsVm, ContactUsVm, int, int>, IRequestService
    {
        public RequestService(IRepositoryActionResult repositoryActionResult, IUnitOfWork<TBL_ContactUs, int> unitOfWork, Microsoft.AspNetCore.Http.IHttpContextAccessor httpContextAccessor, IMapper _mapper)
